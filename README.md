...
- [결정사항]
  ...
  -> 현재 시간(토요일,18)
  2. 강의 계획
  -> 발표내용의 경우 모두 약 90±15분으로 유사한 길이를 가지고 있음 / 아래의 경우를 제외하곤 한 섹션당 한 주에 진행
  -> 섹션 0.강의소개//섹션 1.[기초편]기초다지기//섹션 2.[기초편]쿠버네티스 설치
  => 개별로 학습
  => 이전 도커에서 다룬 내용과 쿠버네티스 설치 등의 내용으로 내용 중복
  ...
  ->섹션 9.[Deprecated]질의응답 미지원 강의
  => CKA 시험에 관한 내용이기에 필요한 인원 개인 학습
